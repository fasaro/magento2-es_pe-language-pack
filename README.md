...
composer require fasaro/magento2-es_pe-language-pack dev-master
php bin/magento setup:static-content:deploy es_PE
...
```
php bin/magento maintenance:enable
composer update fasaro/magento2-es_pe-language-pack dev-master
php bin/magento setup:static-content:deploy es_PE
php bin/magento indexer:reindex
php bin/magento cache:clean
php bin/magento cache:flush
